...
public class SscPanel extends JFrame {
	 ...
	 */
	public SscPanel() {
		setTitle("SSC Information");
	    conn=MysqlConnect.connect();
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 736, 597);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					String query="insert into ssc (citizen_nid,registation_no,department,gpa,board,year,institute) values(?,?,?,?,?,?,?)";
		...
		JLabel lblSscPanel = new JLabel("SECONDARY SCHOOL  CERTIFICATE (SSC)");
		lblSscPanel.setFont(new Font("Tahoma", Font.BOLD, 14));
